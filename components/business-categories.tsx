              ...
              <article className="flex h-full w-full items-center justify-center focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300">
                <div className="absolute -translate-x-[136px]">
                  <div className="animate-[breath_7s_ease-in-out_3s_infinite_both]">
                    <div className=" font-bold flex h-20 w-20 items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-white before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                      Simple
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute -translate-x-[216px] -translate-y-[82px]">
                  <div className="animate-[breath_6s_ease-in-out_3.5s_infinite_both]">
                    <div className="flex h-20 w-20 text-center items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-white before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                    Track Area
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute -translate-x-[216px] translate-y-[82px]">
                  <div className="animate-[breath_6s_ease-in-out_2.5s_infinite_both]">
                    <div className="flex h-20 w-20 items-center justify-center rounded-full bg-white shadow-lg text-center shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-white before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                  Duplicate Check
                    </div>
                  </div>
                </div>
                <div className="absolute -translate-x-[292px]">
                  <div className="animate-[breath_6s_ease-in-out_2s_infinite_both]">
                    <div className="flex h-20 w-20 text-center items-center justify-center rounded-full border border-gray-200/60 bg-white shadow-lg">
                    Aggregate Listing
                    </div>
                  </div>
                </div>
