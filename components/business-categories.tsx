  ...
  return (
    <div className="scale-50 lg:scale-125">
            ...
            <div className="relative flex h-[324px] items-center justify-center">
              ...
              <div className="absolute before:absolute before:-inset-3 before:animate-[spin_3s_linear_infinite] before:rounded-full before:border before:border-transparent before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] before:[background:conic-gradient(from_180deg,transparent,theme(colors.blue.500))_border-box]">
                <div className="animate-[breath_8s_ease-in-out_infinite_both]">
                  <div className="relative flex h-24 w-24 items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-white before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                  </div>
                </div>
              </div>
              <div className="absolute before:absolute before:-inset-3 before:animate-[spin_3s_linear_infinite] before:rounded-full before:border before:border-transparent before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] before:[background:conic-gradient(from_180deg,transparent,theme(colors.blue.500))_border-box]">
                <div className="animate-[breath_8s_ease-in-out_infinite_both]">
                  <div className="flex h-24 w-24 items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-white before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                    <Image
                      className="relative"
                      src={mainlogo}
                      width={50}
              ...
              <div className="relative flex flex-col text-[12px]">
                <article className="flex h-full w-full items-center justify-center focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300">
                  <div className="absolute -translate-x-[136px]">
                    ...
                    <div className="font-bold text-blue-500 flex h-20 w-20 items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-white before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                    Simple
                      </div>
                    </div>
                  </div>
                  <div className="absolute translate-x-[136px]">
                    <div className="animate-[breath_7s_ease-in-out_3.5s_infinite_both]">
                      <div className="font-bold text-green-500 flex h-20 w-20 items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-white before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                        Fast
                      </div>
                    </div>
                  </div>
                  <div className="absolute -translate-x-[216px] -translate-y-[82px]">
                    <div className="animate-[breath_6s_ease-in-out_3.5s_infinite_both]">
                      <div className="flex h-20 w-20 text-center text-black items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-white before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                        Total Area Track
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="absolute -translate-x-[292px]">
                    <div className="animate-[breath_6s_ease-in-out_2s_infinite_both]">
                      <div className="flex h-20 w-20 text-center text-black items-center justify-center rounded-full border border-gray-200/60 bg-white shadow-lg">
                        Aggregate Listing
                      </div>
                    </div>
                  </div>
                  <div className="absolute translate-x-[292px]">
                    <div className="animate-[breath_6s_ease-in-out_4s_infinite_both]">
                      <div className="flex h-20 w-20 text-center text-black items-center justify-center rounded-full border border-gray-200 bg-white shadow-lg">
                        AI Personal Staff
                      </div>
                    </div>
                  </div>
      ...
      <div className="mb-[200px] scale-75 mx-auto max-w-xs sm:flex sm:max-w-none sm:justify-center">
        <a
          className="btn w-full text-xl bg-[#83d454] text-white md:w-1/4 shadow hover:bg-amber-100 hover:text-black sm:ml-4 sm:w-auto"
          href="/contactUs"
        >
          Learn More
        </a>
