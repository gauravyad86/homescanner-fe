...
export default function LargeTestimonial() {
  ...
  return (
    <section className="mb-[100px] px-4">
      ...
      {/* Slider Container */}
      <div className="mt-12 relative w-[1200px] h-[300px] mx-auto overflow-hidden">
        <div
          className={`flex ${
        ...
        {/* Navigation Buttons with arrow signs */}
        <button
          onClick={handlePrev}
          className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-blue-500 text-white p-2 rounded-full scale-x-[-1]"
        >
         &#x27A9;
        </button>
        <button
